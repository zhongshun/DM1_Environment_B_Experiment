...
for experiment_i = 1:Number_of_Experiments
    ...
    if ~USE_BaselineMinimax
        ...
        Asset_index = zeros(1,Number_of_Assets);
        while true
    ...
    %% Create environment
    if nnz(Asset_index) == Number_of_Assets
        ...
        for step = 1:T_execution
            ...
            Tree_Opponent = BuildMinimaxTree_BF(Initial_Agent,Initial_Opponent,Initial_Agent_Region,Assets,...
                Assets_Collected,environment,Lookahead,Negtive_Reward,Negtive_Asset,Visibility_Data,Region,Assets_Detected_Opponent,Asset_Visibility_Data,Visibility_in_environment,step,Resolution,Discount_factor,epsilon);
            ...
            [Initial_Agent1,Initial_Opponent_update,Initial_Agent_Region_opponent,Assets_Collected] = ...
                ...
                Function_index_size,Visibility_Data,Region,Asset_Visibility_Data,Visibility_in_environment,...
                step,Discount_factor,environment,Precompute_Path,Assets_Detected_Opponent,heur_penalty_std,heur_agent_detection_weight,...
